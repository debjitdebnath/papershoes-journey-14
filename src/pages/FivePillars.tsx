  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-24">
        <section className="py-16 md:py-24 bg-beige" ref={ref}>
                  ...
                  <ul className="space-y-3">
                    {pillar.bullets.map((bullet, bulletIndex) => (
                      <li key={bulletIndex} className="flex items-start gap-3">
                        <span
                          className={`${pillar.accentClass} text-sm mt-1.5 flex-shrink-0 leading-none`}
                        >
                          {pillar.symbol}
                        </span>
                ...
                {connectiveLogic.map((item, index) => (
                  ...
                  >
                    ...
                    {index < connectiveLogic.length - 1 && (
                      <span className="text-muted-foreground/50 mx-1 hidden md:inline">→</span>
                    )}
                  </div>
                ))}
              </div>
