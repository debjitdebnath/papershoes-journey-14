...
export const routeStops: RouteStop[] = [
  ...
  },
  {
    ...
    days: 6,
    marathons: 6,
    theme: 'Heritage & Responsible Tourism',
    chapter: 'Running Through Heritage',
    x: 33,
    y: 92,
    story:
      'Among 500-year-old ruins and the boulder landscape of the Tungabhadra, tourist plastic collects where stone has stood for centuries. Six days running between temples, river and village.',
    impact: 'Heritage-site cleanups and a plastic-free visitor pledge with local guides.',
    route: 'Virupaksha – Hampi Bazaar – Tungabhadra riverside loop',
    why: 'Hampi shows what unmanaged tourism does to a UNESCO landscape — bottles and wrappers accumulating around monuments and along the river that carries them onward.',
    challenges: [
      'Single-use plastic from high visitor footfall',
      'Waste dumping around monuments and boulder fields',
      'Plastic entering the Tungabhadra, a Krishna-basin tributary',
    ],
    significance: 'The campaign’s heritage chapter — protecting culture and river together before the route turns to the coast.',
    partners: ['Heritage site guides', 'Local tourism associations', 'Tungabhadra river volunteers'],
    events: ['Monument-zone cleanup', 'Responsible tourism pledge drive', 'Sunrise run through the ruins'],
    schools: 'Village school sessions on heritage and waste.',
    volunteer: 'Cleanup crews and visitor outreach at entry points.',
    journal: 'Where stone outlasts everything except plastic.',
    media: 'Travel, heritage and regional press.',
    metrics: [
