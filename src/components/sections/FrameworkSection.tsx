  ...
  return <section id="framework" className="py-24 bg-beige" ref={ref}>
      <div className="container mx-auto px-6">
        ...
        duration: 0.6
          ...
          <h2 className="md:text-5xl font-bold text-foreground mb-4 font-serif text-4xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {frameworks.map((framework, index) => <motion.div key={framework.title} initial={{
          opacity: 0,
          y: 30
        }} animate={isInView ? {
          opacity: 1,
          ...
          duration: 0.6,
          delay: index * 0.1
        }} className={`bg-card rounded-2xl p-8 shadow-soft hover:shadow-card transition-all duration-300 ${index === 4 ? 'md:col-span-2 lg:col-span-1' : ''}`}>
