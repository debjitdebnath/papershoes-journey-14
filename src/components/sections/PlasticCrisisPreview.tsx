...
const PlasticCrisisPreview = () => {
  ...
  return (
    <section ref={ref} className="py-14 md:py-16 bg-earth text-primary-foreground relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <span className="inline-flex items-center gap-2 px-3 py-1 bg-primary-foreground/10 text-primary-foreground text-xs font-medium rounded-full mb-4">
          ...
          <div className="grid grid-cols-4 gap-3 mb-6">
            {[
              ...
              <div key={s.label} className="bg-primary-foreground/10 rounded-xl p-3">
                ...
                <p className="text-[11px] text-primary-foreground/70">{s.label}</p>
              </div>
            ))}
          </div>
